...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Timeline pop-in (semua elemen muncul bersamaan) ──
  ...
  tl.to(
    [daunAtas, lampuKiri, lampuKanan, daunKiri, daunKanan, bungaKiri, bungaKanan, mainCircle, taliBawah],
  ...
  // ── Section 1: Mempelai ──
  const sectionMempelai = document.querySelector('#mainSection > section:nth-of-type(1)');
  if (sectionMempelai) {
  ...
  const sectionTanggal = document.querySelector('#mainSection > section:nth-of-type(2)');
  if (sectionTanggal) fadeUp(sectionTanggal);

  // ── Section 3: Location ──
  const sectionLocation = document.querySelector('#mainSection > section:nth-of-type(3)');
  if (sectionLocation) {
  ...
  // ── Section 4: Our Story ──
  const sectionStory = document.querySelector('#mainSection > section:nth-of-type(4)');
  if (sectionStory) {
    // Heading dulu
  ...
  const sectionPenutup = document.querySelector('#mainSection > section:nth-of-type(5)');
  if (sectionPenutup) {
