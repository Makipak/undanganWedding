...
//
//  PENTING soal urutan play() vs seek: SELALU play() dulu, baru set
//  currentTime setelah play() resolve — jangan dibalik. Diverifikasi
//  langsung di iPhone: kalau di-seek SAAT MASIH PAUSED (readyState
//  baru HAVE_METADATA, belum ada data ter-buffer di posisi tujuan),
//  iOS diam-diam mulai muter dari data yang sudah ke-buffer (awal
//  file) sementara currentTime cuma "nempel" ke angka yang diminta
//  tanpa pernah benar-benar sampai situ — kedengarannya seperti lagu
//  "ngulang dari awal" padahal secara data sudah "lanjut". Begitu
//  elemen aktif memutar (setelah play() resolve), seek jauh lebih
//  reliable karena browser sedang aktif buffering data baru.
// ============================================================
(() => {
